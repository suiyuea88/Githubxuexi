...
> V1.0.0 稳定封装版：黛青国风书院 UI、接口强连接、项目搜索、临时浏览器运行、运行前仓库检测、README 小白导学、英文翻译、报错诊断、学习笔记和个人学习中心。
...
项目藏馆支持按项目名、作者、编程语言、中文用途和标签搜索。小白报错诊断支持 Python 缺包、命令不存在、Node.js 依赖冲突、端口占用、权限、CORS、404 和身份验证等常见场景。
